...
/**
 * Los municipios de El Salvador con el departamento al que pertenecen.
 *
 * Sirve para que no se escape una guía con "San Vicente, San Salvador", que es
 * un error caro: el paquete sale para el otro lado del país.
 *
 * Hay nombres que se repiten en más de un departamento — El Rosario existe en
 * tres. Esos van con una lista, y el panel pregunta en vez de adivinar.
 *
 * Se usan los 262 municipios históricos y no los 44 distritos de la reforma de
 * 2023, porque los clientes siguen escribiendo el nombre de toda la vida.
 *
 * Si falta alguno o hay algo mal, se corrige acá y listo.
 */
return [
    ...
    'Quelepa' => 'San Miguel',
    'San Antonio del Mosco' => 'San Miguel',
    ...
    'Polorós' => 'La Unión',
    'San Alejo' => 'La Unión',
    'San José La Fuente' => 'La Unión',
    'Santa Rosa de Lima' => 'La Unión',
    'Yayantique' => 'La Unión',
    'Yucuaiquín' => 'La Unión',

    // ── Nombres que existen en más de un departamento ────────────────────────
    // Acá no se puede adivinar: el panel avisa y hay que elegir.
    'El Rosario' => ['La Paz', 'Cuscatlán', 'Morazán'],
    'El Carmen' => ['Cuscatlán', 'La Unión'],
    'San Fernando' => ['Chalatenango', 'Morazán'],
    'San Isidro' => ['Cabañas', 'Morazán'],
    'San Lorenzo' => ['Ahuachapán', 'San Vicente'],
    'San José' => ['La Unión', 'Chalatenango'],
